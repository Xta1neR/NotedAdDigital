  ...
  return (
    <div className="max-w-[1024px] mx-auto my-5 md:my-10 px-4 md:px-0 z-0">
      ...
      <div className="relative rounded-xl md:rounded-2xl overflow-hidden p-6 md:p-10">
        ...
        <div 
          aria-hidden="true" 
          className="absolute mx-auto p-5 top-55 opacity-50 z-10"
        >
          <span className="font-anton text-[100px] md:text-[150px] text-white leading-none text-center ">
            Life at NAD
          </span>
        </div>
        ...
        <div className="flex items-start mb-6 md:mb-10">
          ...
          <div>
            <h1 className="text-white text-3xl md:text-4xl font-bold leading-tight">
              ...
              <span className="block">TO CREATIVE</span>
              <span className="text-[#f04e00]">EXCELLENCE.</span>
            </h1>
        ...
        <div className="flex flex-col md:flex-row gap-6 mb-6 md:mb-10">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 w-full">
            <span className="text-5xl md:text-6xl font-bold text-white/50 font-anton leading-none">
              100+
            </span>
            <div className="bg-[#f04e00] text-white text-xs md:text-sm font-semibold rounded-lg px-4 py-2 uppercase max-w-[200px] text-center">
              Brands Boosted
            </div>
          </div>
        </div>
